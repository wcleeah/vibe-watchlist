...
export class VideoService {
    ...
    static async create(data: VideoCreateRequest): Promise<VideoWithTags> {
        const response = await fetch(VideoService.API_BASE, {
            method: 'POST',
            headers: {
    ...
    static async update(
        ...
        const response = await fetch(`${VideoService.API_BASE}/${id}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    static async getAll(
        ...
        const response = await fetch(
            `${VideoService.API_BASE}?${params.toString()}`,
        )
    ...
    static async bulkUpdate(
        ids: number[],
        data: Partial<VideoUpdateRequest>,
    ): Promise<void> {
        const response = await fetch(`${VideoService.API_BASE}/bulk`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
            },
