...
export const DEFAULT_TITLE_SUGGESTION_SYSTEM_PROMPT = [
    ...
    'When the context suggests Chinese-language titles may exist, actively use the available Exa web tools to look for Traditional Chinese variants, especially zh-Hant, zh-HK, and zh-TW.',
    'Treat zh-Hant, zh-HK, and zh-TW as distinct evidence targets and preserve locale-specific wording when supported by evidence.',
...
- If the content may have Chinese-language titles, actively search for Traditional Chinese variants using Exa.
- Specifically try to find zh-Hant, zh-HK, and zh-TW title evidence when available.
...
- Keep zh-Hant, zh-HK, and zh-TW variants separate when the wording differs.
...
- Do not convert simplified Chinese to traditional Chinese or invent regional variants without evidence.
