    ...
    return (
        <div className='bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-6'>
            ...
            <p className='text-gray-600 dark:text-gray-400 text-sm mb-6'>
                Test URLs against platform patterns to see which platforms match
            ...
            {results.length > 0 && (
                <div className='space-y-3'>
                    <h4 className='text-sm font-medium text-gray-900 dark:text-gray-100'>
                        Test Results ({results.filter((r) => r.matched).length}{' '}
                        matches)
                    </h4>
                    ...
                    {results.filter((r) => r.matched).length === 0 && (
                        <div className='text-center py-8 text-gray-500'>
                            ...
                            <p className='text-sm mt-1'>
                                Try adding a new platform with appropriate
                                patterns
                            </p>
                        </div>
                    )}
            ...
            <div className='mt-6 p-4 bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded-lg'>
                ...
                <ul className='text-xs text-blue-700 dark:text-blue-300 space-y-1'>
                    <li>
                        • Enter a URL to test against all configured platform
                        patterns
                    </li>
                    <li>
                        • Green results indicate successful matches with
                        confidence scores
                    </li>
                    <li>
                        • Patterns are tested in order of platform configuration
                    </li>
                    <li>
                        • Use this to debug platform detection or validate new
                        patterns
                    </li>
                </ul>
            </div>
