      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 text-xs text-gray-500">
            <PlatformBadge platform={suggestion.platform} size="sm" variant="ghost" />
...
interface MetadataOptionCompactProps extends Omit<MetadataOptionProps, 'className'> {
    ...
    >
      ...
      {suggestion.thumbnailUrl && (
        <div className={cn(
          ...
          isHorizontal ? "w-16 h-12 flex-shrink-0" : "w-full aspect-video mb-2"
        )}>
          <img
            src={suggestion.thumbnailUrl}
            alt="Video thumbnail"
      ...
      <div className={cn(isHorizontal ? "flex-1 min-w-0" : "")}>
        ...
        {isHorizontal && suggestion.reasoning && (
          <p className="text-xs text-gray-500 truncate mt-1" title={suggestion.reasoning}>
            {suggestion.reasoning}
          </p>
        )}
      </div>
